"""backend/domain/services_type/repository.py"""

from typing import Any, AsyncGenerator

from sqlalchemy import Result, select

from backend.domain.services_type import ServiceType, ServiceTypeUncommited
from backend.infrastructure.database import BaseRepository, ServiceTypeTable
