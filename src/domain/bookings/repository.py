"""src/domain/bookings/repository.py"""

from typing import Any, AsyncGenerator

from src.domain.bookings import Booking, BookingUncommited
from src.infrastructure.database import BaseRepository, BookingTable
